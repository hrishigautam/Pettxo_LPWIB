      ...
      <div ref={ref} className="contact-page">
        ...
        <section className="bg-beige pt-32 pb-14 md:pt-40 md:pb-16 reveal-group">
          <div className="max-w-[1280px] mx-auto px-6 md:px-16">
            ...
            <h1
              className="reveal font-serif font-black leading-[1.08] tracking-[-0.02em] text-dark mb-6 max-w-[760px]"
          ...
          <div className="max-w-[1280px] mx-auto px-6 md:px-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <ContactCard
                ...
                body="For anything about using Pettxo, your account, or a booking."
              >
                <a
                  href="mailto:support@pettxo.com"
                  className="text-orange font-medium text-[15px] hover:underline"
                >
              ...
              <ContactCard
                ...
                body="Want to list your services or have a question about your profile?"
              >
                <Link
                  to="/for-providers"
                  className="text-orange font-medium text-[15px] hover:underline"
              ...
              <ContactCard
                ...
                body="For media, collaborations, and partnership enquiries."
              >
                <a
              ...
              <ContactCard
                title="Social"
                body="Come say hi and see what the community's building."
              >
          ...
          <div className="max-w-[1280px] mx-auto px-6 md:px-16 max-w-[760px]">
            ...
            <div className="flex flex-col gap-8">
              {FAQ.map((f, i) => (
                <div
                  key={i}
                  className="reveal border-l-[3px] border-orange pl-5"
                >
        ...
        <section className="bg-card py-14 md:py-20 reveal-group">
          <div className="max-w-[1280px] mx-auto px-6 md:px-16 text-center max-w-[620px] mx-auto flex flex-col items-center">
            ...
            <h2
              className="reveal font-serif font-black text-dark leading-[1.12] tracking-[-0.02em] mb-8"
            ...
            <div className="reveal flex flex-col items-center gap-5">
              ...
              <p className="text-[13px] font-semibold tracking-[0.16em] uppercase text-orange">
                Care · Trust · Love
              </p>
...
function ContactCard({ title, body, children }) {
  return (
    <div className="reveal bg-card border border-[#E5E7EB] rounded-[18px] p-7 md:p-8">
      ...
      <p className="text-[15px] font-light leading-[1.7] text-muted mb-4">
        {body}
      </p>
